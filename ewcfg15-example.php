...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "15.0.1");
...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "BIBLIOTECA"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{E6872B47-A984-4C9A-BBE6-E4ECB78C3960}"); // Project ID (GUID)
define(PROJECT_NAMESPACE . "RANDOM_KEY", '62k1h4axuMswpCDi'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/BIBLIOTECA.css"); // Project stylesheet file name
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "host", "port" => 3306, "user" => "user", "pass" => "password", "db" => "namedatabase", "qs" => "`", "qe" => "`");
...
// Language settings
define(PROJECT_NAMESPACE . "LANGUAGE_FOLDER", $RELATIVE_PATH . "phplang/");
$LANGUAGE_FILE = [];
...
define(PROJECT_NAMESPACE . "ADMIN_USER_NAME", "Javier"); // Administrator user name
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "Javier"); // Administrator password
