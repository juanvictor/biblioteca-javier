...
// Create page object
$t_transaccion_edit = new t_transaccion_edit();

// Run the page
$t_transaccion_edit->run();
...
$t_transaccion_edit->Page_Render();
?>
...
var ft_transaccionedit = currentForm = new ew.Form("ft_transaccionedit", "edit");

// Validate form
ft_transaccionedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t_transaccion_edit->Id_tran->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_transaccion_edit->CI_Lector->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_transaccion_edit->Nombres->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_transaccion_edit->Apellidos->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_transaccion_edit->Cod_libro->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_transaccion_edit->Titulo->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_transaccion_edit->Fecha_Prestamo->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_transaccion_edit->Fecha_Devolucion->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_transaccion_edit->Estado->Required) { ?>
...
ft_transaccionedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft_transaccionedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ft_transaccionedit.lists["x_CI_Lector"] = <?php echo $t_transaccion_edit->CI_Lector->Lookup->toClientList() ?>;
ft_transaccionedit.lists["x_CI_Lector"].options = <?php echo JsonEncode($t_transaccion_edit->CI_Lector->lookupOptions()) ?>;
ft_transaccionedit.lists["x_Cod_libro"] = <?php echo $t_transaccion_edit->Cod_libro->Lookup->toClientList() ?>;
ft_transaccionedit.lists["x_Cod_libro"].options = <?php echo JsonEncode($t_transaccion_edit->Cod_libro->lookupOptions()) ?>;
...
<?php $t_transaccion_edit->showPageHeader(); ?>
<?php
$t_transaccion_edit->showMessage();
?>
<form name="ft_transaccionedit" id="ft_transaccionedit" class="<?php echo $t_transaccion_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t_transaccion_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t_transaccion_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_transaccion">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$t_transaccion_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($t_transaccion->Id_tran->Visible) { // Id_tran ?>
	<div id="r_Id_tran" class="form-group row">
		<label id="elh_t_transaccion_Id_tran" class="<?php echo $t_transaccion_edit->LeftColumnClass ?>"><?php echo $t_transaccion->Id_tran->caption() ?><?php echo ($t_transaccion->Id_tran->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_transaccion_edit->RightColumnClass ?>"><div<?php echo $t_transaccion->Id_tran->cellAttributes() ?>>
...
<input type="hidden" data-table="t_transaccion" data-field="x_Id_tran" name="x_Id_tran" id="x_Id_tran" value="<?php echo HtmlEncode($t_transaccion->Id_tran->CurrentValue) ?>">
<?php echo $t_transaccion->Id_tran->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_transaccion->CI_Lector->Visible) { // CI_Lector ?>
	<div id="r_CI_Lector" class="form-group row">
		<label id="elh_t_transaccion_CI_Lector" for="x_CI_Lector" class="<?php echo $t_transaccion_edit->LeftColumnClass ?>"><?php echo $t_transaccion->CI_Lector->caption() ?><?php echo ($t_transaccion->CI_Lector->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_transaccion_edit->RightColumnClass ?>"><div<?php echo $t_transaccion->CI_Lector->cellAttributes() ?>>
...
<?php if ($t_transaccion->Nombres->Visible) { // Nombres ?>
	<div id="r_Nombres" class="form-group row">
		<label id="elh_t_transaccion_Nombres" for="x_Nombres" class="<?php echo $t_transaccion_edit->LeftColumnClass ?>"><?php echo $t_transaccion->Nombres->caption() ?><?php echo ($t_transaccion->Nombres->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_transaccion_edit->RightColumnClass ?>"><div<?php echo $t_transaccion->Nombres->cellAttributes() ?>>
...
<?php if ($t_transaccion->Apellidos->Visible) { // Apellidos ?>
	<div id="r_Apellidos" class="form-group row">
		<label id="elh_t_transaccion_Apellidos" for="x_Apellidos" class="<?php echo $t_transaccion_edit->LeftColumnClass ?>"><?php echo $t_transaccion->Apellidos->caption() ?><?php echo ($t_transaccion->Apellidos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_transaccion_edit->RightColumnClass ?>"><div<?php echo $t_transaccion->Apellidos->cellAttributes() ?>>
...
<?php if ($t_transaccion->Cod_libro->Visible) { // Cod_libro ?>
	<div id="r_Cod_libro" class="form-group row">
		<label id="elh_t_transaccion_Cod_libro" for="x_Cod_libro" class="<?php echo $t_transaccion_edit->LeftColumnClass ?>"><?php echo $t_transaccion->Cod_libro->caption() ?><?php echo ($t_transaccion->Cod_libro->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_transaccion_edit->RightColumnClass ?>"><div<?php echo $t_transaccion->Cod_libro->cellAttributes() ?>>
...
<?php if ($t_transaccion->Titulo->Visible) { // Titulo ?>
	<div id="r_Titulo" class="form-group row">
		<label id="elh_t_transaccion_Titulo" for="x_Titulo" class="<?php echo $t_transaccion_edit->LeftColumnClass ?>"><?php echo $t_transaccion->Titulo->caption() ?><?php echo ($t_transaccion->Titulo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_transaccion_edit->RightColumnClass ?>"><div<?php echo $t_transaccion->Titulo->cellAttributes() ?>>
...
<?php if ($t_transaccion->Estado->Visible) { // Estado ?>
	<div id="r_Estado" class="form-group row">
		<label id="elh_t_transaccion_Estado" for="x_Estado" class="<?php echo $t_transaccion_edit->LeftColumnClass ?>"><?php echo $t_transaccion->Estado->caption() ?><?php echo ($t_transaccion->Estado->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_transaccion_edit->RightColumnClass ?>"><div<?php echo $t_transaccion->Estado->cellAttributes() ?>>
...
<?php if (!$t_transaccion_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t_transaccion_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t_transaccion_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t_transaccion_edit->showPageFooter();
if (DEBUG_ENABLED)
