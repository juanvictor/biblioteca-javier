...
var ft_lectoradd = currentForm = new ew.Form("ft_lectoradd", "add");

// Validate form
ft_lectoradd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t_lector_add->CI_DNI->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_lector_add->Nombres->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_lector_add->Apellidos->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_lector_add->Direccion->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_lector_add->Telefono->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_lector_add->Tipo_Lector->Required) { ?>
		...
		<?php } ?>
		<?php if ($t_lector_add->Institucion->Required) { ?>
...
ft_lectoradd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft_lectoradd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $t_lector_add->showPageHeader(); ?>
<?php
$t_lector_add->showMessage();
?>
<form name="ft_lectoradd" id="ft_lectoradd" class="<?php echo $t_lector_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t_lector_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t_lector_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_lector">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$t_lector_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($t_lector->CI_DNI->Visible) { // CI_DNI ?>
	<div id="r_CI_DNI" class="form-group row">
		<label id="elh_t_lector_CI_DNI" for="x_CI_DNI" class="<?php echo $t_lector_add->LeftColumnClass ?>"><?php echo $t_lector->CI_DNI->caption() ?><?php echo ($t_lector->CI_DNI->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_lector_add->RightColumnClass ?>"><div<?php echo $t_lector->CI_DNI->cellAttributes() ?>>
...
<?php if ($t_lector->Nombres->Visible) { // Nombres ?>
	<div id="r_Nombres" class="form-group row">
		<label id="elh_t_lector_Nombres" for="x_Nombres" class="<?php echo $t_lector_add->LeftColumnClass ?>"><?php echo $t_lector->Nombres->caption() ?><?php echo ($t_lector->Nombres->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_lector_add->RightColumnClass ?>"><div<?php echo $t_lector->Nombres->cellAttributes() ?>>
...
<?php if ($t_lector->Apellidos->Visible) { // Apellidos ?>
	<div id="r_Apellidos" class="form-group row">
		<label id="elh_t_lector_Apellidos" for="x_Apellidos" class="<?php echo $t_lector_add->LeftColumnClass ?>"><?php echo $t_lector->Apellidos->caption() ?><?php echo ($t_lector->Apellidos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_lector_add->RightColumnClass ?>"><div<?php echo $t_lector->Apellidos->cellAttributes() ?>>
...
<?php if ($t_lector->Direccion->Visible) { // Direccion ?>
	<div id="r_Direccion" class="form-group row">
		<label id="elh_t_lector_Direccion" for="x_Direccion" class="<?php echo $t_lector_add->LeftColumnClass ?>"><?php echo $t_lector->Direccion->caption() ?><?php echo ($t_lector->Direccion->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_lector_add->RightColumnClass ?>"><div<?php echo $t_lector->Direccion->cellAttributes() ?>>
...
<?php if ($t_lector->Telefono->Visible) { // Telefono ?>
	<div id="r_Telefono" class="form-group row">
		<label id="elh_t_lector_Telefono" for="x_Telefono" class="<?php echo $t_lector_add->LeftColumnClass ?>"><?php echo $t_lector->Telefono->caption() ?><?php echo ($t_lector->Telefono->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_lector_add->RightColumnClass ?>"><div<?php echo $t_lector->Telefono->cellAttributes() ?>>
...
<?php if ($t_lector->Tipo_Lector->Visible) { // Tipo_Lector ?>
	<div id="r_Tipo_Lector" class="form-group row">
		<label id="elh_t_lector_Tipo_Lector" for="x_Tipo_Lector" class="<?php echo $t_lector_add->LeftColumnClass ?>"><?php echo $t_lector->Tipo_Lector->caption() ?><?php echo ($t_lector->Tipo_Lector->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_lector_add->RightColumnClass ?>"><div<?php echo $t_lector->Tipo_Lector->cellAttributes() ?>>
...
<?php if ($t_lector->Institucion->Visible) { // Institucion ?>
	<div id="r_Institucion" class="form-group row">
		<label id="elh_t_lector_Institucion" for="x_Institucion" class="<?php echo $t_lector_add->LeftColumnClass ?>"><?php echo $t_lector->Institucion->caption() ?><?php echo ($t_lector->Institucion->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t_lector_add->RightColumnClass ?>"><div<?php echo $t_lector->Institucion->cellAttributes() ?>>
...
<?php if (!$t_lector_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t_lector_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t_lector_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t_lector_add->showPageFooter();
if (DEBUG_ENABLED)
