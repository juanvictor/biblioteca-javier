...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>FGE.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>FGE.ico">
<meta name="generator" content="PHPMaker v2019.0.1">
</head>
