...
// Page class
//
class t_transaccion_add extends t_transaccion
{
	...
	// Page object name
	public $PageObjName = "t_transaccion_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("Id_tran") !== NULL) {
				...
				$this->setKey("Id_tran", $this->Id_tran->CurrentValue); // Set up key
			} else {
				$this->setKey("Id_tran", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_transaccionview.php")
