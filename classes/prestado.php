...
/**
 * Table class for prestado
 */
class prestado extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'prestado';
		$this->TableName = 'prestado';
		$this->TableType = 'VIEW';
		...
		$this->ExportPageSize = "letter"; // Page size (PDF only)
		...
		// CI_Lector
		$this->CI_Lector = new DbField('prestado', 'prestado', 'x_CI_Lector', 'CI_Lector', '`CI_Lector`', '`CI_Lector`', 200, -1, FALSE, '`CI_Lector`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Nombres
		$this->Nombres = new DbField('prestado', 'prestado', 'x_Nombres', 'Nombres', '`Nombres`', '`Nombres`', 200, -1, FALSE, '`Nombres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Apellidos
		$this->Apellidos = new DbField('prestado', 'prestado', 'x_Apellidos', 'Apellidos', '`Apellidos`', '`Apellidos`', 200, -1, FALSE, '`Apellidos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Titulo
		$this->Titulo = new DbField('prestado', 'prestado', 'x_Titulo', 'Titulo', '`Titulo`', '`Titulo`', 200, -1, FALSE, '`Titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Fecha_Prestamo
		$this->Fecha_Prestamo = new DbField('prestado', 'prestado', 'x_Fecha_Prestamo', 'Fecha_Prestamo', '`Fecha_Prestamo`', CastDateFieldForLike('`Fecha_Prestamo`', 0, "DB"), 133, 0, FALSE, '`Fecha_Prestamo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`prestado`";
	}
	...
	{
		global $Language;
		if ($pageName == "prestadoview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "prestadoedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "prestadoadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("prestadoview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("prestadoview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "prestadoadd.php?" . $this->getUrlParm($parm);
		else
			$url = "prestadoadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("prestadoedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("prestadoadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("prestadodelete.php", $this->getUrlParm());
	}
