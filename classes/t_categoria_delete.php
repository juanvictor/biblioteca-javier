...
// Page class
//
class t_categoria_delete extends t_categoria
{
	...
	// Page object name
	public $PageObjName = "t_categoria_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("t_categorialist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t_categorialist.php"); // Return to list
			}
		}
	}
