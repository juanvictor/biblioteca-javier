...
// Page class
//
class t_categoria_view extends t_categoria
{
	...
	// Page object name
	public $PageObjName = "t_categoria_view";
	...
	public function __construct()
	{
		...
		if (Get("Id_categoria") !== NULL) {
			$this->RecKey["Id_categoria"] = Get("Id_categoria");
			$keyUrl .= "&amp;Id_categoria=" . urlencode($this->RecKey["Id_categoria"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("Id_categoria") !== NULL) {
				...
				$this->RecKey["Id_categoria"] = $this->Id_categoria->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->Id_categoria->setQueryStringValue(Key(0));
				$this->RecKey["Id_categoria"] = $this->Id_categoria->QueryStringValue;
			} elseif (Post("Id_categoria") !== NULL) {
				$this->Id_categoria->setFormValue(Post("Id_categoria"));
				$this->RecKey["Id_categoria"] = $this->Id_categoria->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->Id_categoria->setFormValue(Route(2));
				$this->RecKey["Id_categoria"] = $this->Id_categoria->FormValue;
			} else {
				$returnUrl = "t_categorialist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t_categorialist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t_categorialist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
