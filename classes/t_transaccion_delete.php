...
// Page class
//
class t_transaccion_delete extends t_transaccion
{
	...
	// Page object name
	public $PageObjName = "t_transaccion_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("t_transaccionlist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t_transaccionlist.php"); // Return to list
			}
		}
	}
