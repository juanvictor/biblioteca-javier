...
// Page class
//
class t_categoria_add extends t_categoria
{
	...
	// Page object name
	public $PageObjName = "t_categoria_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("Id_categoria") !== NULL) {
				...
				$this->setKey("Id_categoria", $this->Id_categoria->CurrentValue); // Set up key
			} else {
				$this->setKey("Id_categoria", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_categoriaview.php")
