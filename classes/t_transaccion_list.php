...
// Page class
//
class t_transaccion_list extends t_transaccion
{
	...
	// Page object name
	public $PageObjName = "t_transaccion_list";

	// Grid form hidden field names
	public $FormName = "ft_transaccionlist";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "t_transacciondelete.php";
		$this->MultiUpdateUrl = "t_transaccionupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft_transaccionlistsrch";
	...
	protected function hideFieldsForAddEdit()
	{
		...
		if ($this->isAddOrEdit())
			$this->Fecha_Prestamo->Visible = FALSE;
		if ($this->isAddOrEdit())
			$this->Fecha_Devolucion->Visible = FALSE;
	}
	...
	public function getFilterList()
	{
		...
		$filterList = "";
		$savedFilterList = "";
		$filterList = Concat($filterList, $this->Id_tran->AdvancedSearch->toJson(), ","); // Field Id_tran
		$filterList = Concat($filterList, $this->CI_Lector->AdvancedSearch->toJson(), ","); // Field CI_Lector
		...
		$filterList = Concat($filterList, $this->Cod_libro->AdvancedSearch->toJson(), ","); // Field Cod_libro
		$filterList = Concat($filterList, $this->Titulo->AdvancedSearch->toJson(), ","); // Field Titulo
		$filterList = Concat($filterList, $this->Fecha_Prestamo->AdvancedSearch->toJson(), ","); // Field Fecha_Prestamo
		$filterList = Concat($filterList, $this->Fecha_Devolucion->AdvancedSearch->toJson(), ","); // Field Fecha_Devolucion
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ft_transaccionlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field Id_tran
		$this->Id_tran->AdvancedSearch->SearchValue = @$filter["x_Id_tran"];
		$this->Id_tran->AdvancedSearch->SearchOperator = @$filter["z_Id_tran"];
		$this->Id_tran->AdvancedSearch->SearchCondition = @$filter["v_Id_tran"];
		$this->Id_tran->AdvancedSearch->SearchValue2 = @$filter["y_Id_tran"];
		$this->Id_tran->AdvancedSearch->SearchOperator2 = @$filter["w_Id_tran"];
		$this->Id_tran->AdvancedSearch->save();

		// Field CI_Lector
		$this->CI_Lector->AdvancedSearch->SearchValue = @$filter["x_CI_Lector"];
		$this->CI_Lector->AdvancedSearch->SearchOperator = @$filter["z_CI_Lector"];
		$this->CI_Lector->AdvancedSearch->SearchCondition = @$filter["v_CI_Lector"];
		$this->CI_Lector->AdvancedSearch->SearchValue2 = @$filter["y_CI_Lector"];
		$this->CI_Lector->AdvancedSearch->SearchOperator2 = @$filter["w_CI_Lector"];
		$this->CI_Lector->AdvancedSearch->save();
		...
		// Field Cod_libro
		$this->Cod_libro->AdvancedSearch->SearchValue = @$filter["x_Cod_libro"];
		$this->Cod_libro->AdvancedSearch->SearchOperator = @$filter["z_Cod_libro"];
		$this->Cod_libro->AdvancedSearch->SearchCondition = @$filter["v_Cod_libro"];
		$this->Cod_libro->AdvancedSearch->SearchValue2 = @$filter["y_Cod_libro"];
		$this->Cod_libro->AdvancedSearch->SearchOperator2 = @$filter["w_Cod_libro"];
		$this->Cod_libro->AdvancedSearch->save();
		...
		$this->Fecha_Prestamo->AdvancedSearch->SearchValue = @$filter["x_Fecha_Prestamo"];
		$this->Fecha_Prestamo->AdvancedSearch->SearchOperator = @$filter["z_Fecha_Prestamo"];
		$this->Fecha_Prestamo->AdvancedSearch->SearchCondition = @$filter["v_Fecha_Prestamo"];
		$this->Fecha_Prestamo->AdvancedSearch->SearchValue2 = @$filter["y_Fecha_Prestamo"];
		$this->Fecha_Prestamo->AdvancedSearch->SearchOperator2 = @$filter["w_Fecha_Prestamo"];
		$this->Fecha_Prestamo->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		global $Security;
		$where = "";
		$this->buildSearchSql($where, $this->Id_tran, $default, FALSE); // Id_tran
		$this->buildSearchSql($where, $this->CI_Lector, $default, FALSE); // CI_Lector
		...
		$this->buildSearchSql($where, $this->Cod_libro, $default, FALSE); // Cod_libro
		$this->buildSearchSql($where, $this->Titulo, $default, FALSE); // Titulo
		$this->buildSearchSql($where, $this->Fecha_Prestamo, $default, FALSE); // Fecha_Prestamo
		$this->buildSearchSql($where, $this->Fecha_Devolucion, $default, FALSE); // Fecha_Devolucion
		...
		if (!$default && $this->Command == "search") {
			$this->Id_tran->AdvancedSearch->save(); // Id_tran
			$this->CI_Lector->AdvancedSearch->save(); // CI_Lector
			$this->Nombres->AdvancedSearch->save(); // Nombres
			$this->Apellidos->AdvancedSearch->save(); // Apellidos
			$this->Cod_libro->AdvancedSearch->save(); // Cod_libro
			$this->Titulo->AdvancedSearch->save(); // Titulo
			$this->Fecha_Prestamo->AdvancedSearch->save(); // Fecha_Prestamo
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->CI_Lector, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Nombres, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Apellidos, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Cod_libro, $arKeywords, $type);
	...
	protected function checkSearchParms()
	{
		...
		if ($this->BasicSearch->issetSession())
			return TRUE;
		if ($this->Id_tran->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->CI_Lector->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Nombres->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Apellidos->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Cod_libro->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Titulo->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Fecha_Prestamo->AdvancedSearch->issetSession())
			return TRUE;
	...
	{
		$this->Id_tran->AdvancedSearch->unsetSession();
		$this->CI_Lector->AdvancedSearch->unsetSession();
		$this->Nombres->AdvancedSearch->unsetSession();
		$this->Apellidos->AdvancedSearch->unsetSession();
		$this->Cod_libro->AdvancedSearch->unsetSession();
		$this->Titulo->AdvancedSearch->unsetSession();
		$this->Fecha_Prestamo->AdvancedSearch->unsetSession();
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->Id_tran); // Id_tran
			$this->updateSort($this->CI_Lector); // CI_Lector
			$this->updateSort($this->Nombres); // Nombres
			$this->updateSort($this->Apellidos); // Apellidos
			$this->updateSort($this->Cod_libro); // Cod_libro
			$this->updateSort($this->Titulo); // Titulo
			$this->updateSort($this->Fecha_Prestamo); // Fecha_Prestamo
	...
	protected function resetCmd()
	{
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				$orderBy = "";
				$this->setSessionOrderBy($orderBy);
				$this->Id_tran->setSort("");
				$this->CI_Lector->setSort("");
				$this->Nombres->setSort("");
				$this->Apellidos->setSort("");
				$this->Cod_libro->setSort("");
				$this->Titulo->setSort("");
				$this->Fecha_Prestamo->setSort("");
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ew-multi-select\" value=\"" . HtmlEncode($this->Id_tran->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\">";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft_transaccionlistsrch\" href=\"#\">" . $Language->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft_transaccionlistsrch\" href=\"#\">" . $Language->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft_transaccionlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft_transaccionlistsrch\">" . $Language->Phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
		...
		if (IsMobile())
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->Phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->Phrase("AdvancedSearch") . "\" href=\"t_transaccionsrch.php\">" . $Language->Phrase("AdvancedSearchBtn") . "</a>";
		else
			$item->Body = "<button type=\"button\" class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->Phrase("AdvancedSearch") . "\" data-table=\"t_transaccion\" data-caption=\"" . $Language->Phrase("AdvancedSearch") . "\" onclick=\"ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'t_transaccionsrch.php'});\">" . $Language->Phrase("AdvancedSearchBtn") . "</button>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->add("searchhighlight");
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-highlight active\" title=\"" . $Language->Phrase("Highlight") . "\" data-caption=\"" . $Language->Phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"ft_transaccionlistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->Phrase("HighlightBtn") . "</button>";
	...
	protected function loadSearchValues()
	{
		...
		$this->Id_tran->AdvancedSearch->setSearchValue(Get("x_Id_tran", Get("Id_tran", "")));
		if ($this->Id_tran->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Id_tran->AdvancedSearch->setSearchOperator(Get("z_Id_tran", ""));

		// CI_Lector
		$this->CI_Lector->AdvancedSearch->setSearchValue(Get("x_CI_Lector", Get("CI_Lector", "")));
		if ($this->CI_Lector->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->CI_Lector->AdvancedSearch->setSearchOperator(Get("z_CI_Lector", ""));

		// Nombres
		$this->Nombres->AdvancedSearch->setSearchValue(Get("x_Nombres", Get("Nombres", "")));
		if ($this->Nombres->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Nombres->AdvancedSearch->setSearchOperator(Get("z_Nombres", ""));

		// Apellidos
		$this->Apellidos->AdvancedSearch->setSearchValue(Get("x_Apellidos", Get("Apellidos", "")));
		if ($this->Apellidos->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Apellidos->AdvancedSearch->setSearchOperator(Get("z_Apellidos", ""));

		// Cod_libro
		$this->Cod_libro->AdvancedSearch->setSearchValue(Get("x_Cod_libro", Get("Cod_libro", "")));
		if ($this->Cod_libro->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Cod_libro->AdvancedSearch->setSearchOperator(Get("z_Cod_libro", ""));
		...
		// Fecha_Prestamo
		$this->Fecha_Prestamo->AdvancedSearch->setSearchValue(Get("x_Fecha_Prestamo", Get("Fecha_Prestamo", "")));
		if ($this->Fecha_Prestamo->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Fecha_Prestamo->AdvancedSearch->setSearchOperator(Get("z_Fecha_Prestamo", ""));

		// Fecha_Devolucion
		$this->Fecha_Devolucion->AdvancedSearch->setSearchValue(Get("x_Fecha_Devolucion", Get("Fecha_Devolucion", "")));
		if ($this->Fecha_Devolucion->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Fecha_Devolucion->AdvancedSearch->setSearchOperator(Get("z_Fecha_Devolucion", ""));

		// Estado
		$this->Estado->AdvancedSearch->setSearchValue(Get("x_Estado", Get("Estado", "")));
		if ($this->Estado->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Estado->AdvancedSearch->setSearchOperator(Get("z_Estado", ""));
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->isExport())
				$this->Id_tran->ViewValue = $this->highlightValue($this->Id_tran);
			...
			if (!$this->isExport())
				$this->Apellidos->ViewValue = $this->highlightValue($this->Apellidos);
			...
			if (!$this->isExport())
				$this->Estado->ViewValue = $this->highlightValue($this->Estado);
		}
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_t_transaccion\" class=\"ew-export-link ew-email\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_t_transaccion',hdr:ew.language.phrase('ExportToEmailText'),f:document.ft_transaccionlist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
