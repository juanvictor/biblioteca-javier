...
// Page class
//
class t_lector_delete extends t_lector
{
	...
	// Page object name
	public $PageObjName = "t_lector_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("t_lectorlist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t_lectorlist.php"); // Return to list
			}
		}
	}
