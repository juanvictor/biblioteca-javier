...
// Page class
//
class t_categoria_addopt extends t_categoria
{
	...
	// Page object name
	public $PageObjName = "t_categoria_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->Categoria->IsDetailKey) {
			$this->Categoria->setFormValue(ConvertFromUtf8($val));
		}
	...
	{
		global $CurrentForm;
		$this->Categoria->CurrentValue = ConvertToUtf8($this->Categoria->FormValue);
	}
