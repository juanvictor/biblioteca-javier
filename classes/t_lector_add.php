...
// Page class
//
class t_lector_add extends t_lector
{
	...
	// Page object name
	public $PageObjName = "t_lector_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("Id_lector") !== NULL) {
				...
				$this->setKey("Id_lector", $this->Id_lector->CurrentValue); // Set up key
			} else {
				$this->setKey("Id_lector", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_lectorview.php")
