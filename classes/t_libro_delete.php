...
// Page class
//
class t_libro_delete extends t_libro
{
	...
	// Page object name
	public $PageObjName = "t_libro_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("t_librolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t_librolist.php"); // Return to list
			}
		}
	}
