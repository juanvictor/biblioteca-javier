...
// Page class
//
class t_lector_list extends t_lector
{
	...
	// Page object name
	public $PageObjName = "t_lector_list";

	// Grid form hidden field names
	public $FormName = "ft_lectorlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "t_lectoradd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t_lectordelete.php";
		$this->MultiUpdateUrl = "t_lectorupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft_lectorlistsrch";
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->Id_lector->setFormValue($arKeyFlds[0]);
			if (!is_numeric($this->Id_lector->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		$filterList = "";
		$savedFilterList = "";
		$filterList = Concat($filterList, $this->Id_lector->AdvancedSearch->toJson(), ","); // Field Id_lector
		$filterList = Concat($filterList, $this->CI_DNI->AdvancedSearch->toJson(), ","); // Field CI_DNI
		...
		$filterList = Concat($filterList, $this->Tipo_Lector->AdvancedSearch->toJson(), ","); // Field Tipo_Lector
		$filterList = Concat($filterList, $this->Institucion->AdvancedSearch->toJson(), ","); // Field Institucion
		if ($this->BasicSearch->Keyword <> "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ft_lectorlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field Id_lector
		$this->Id_lector->AdvancedSearch->SearchValue = @$filter["x_Id_lector"];
		$this->Id_lector->AdvancedSearch->SearchOperator = @$filter["z_Id_lector"];
		$this->Id_lector->AdvancedSearch->SearchCondition = @$filter["v_Id_lector"];
		$this->Id_lector->AdvancedSearch->SearchValue2 = @$filter["y_Id_lector"];
		$this->Id_lector->AdvancedSearch->SearchOperator2 = @$filter["w_Id_lector"];
		$this->Id_lector->AdvancedSearch->save();

		// Field CI_DNI
		$this->CI_DNI->AdvancedSearch->SearchValue = @$filter["x_CI_DNI"];
		$this->CI_DNI->AdvancedSearch->SearchOperator = @$filter["z_CI_DNI"];
		$this->CI_DNI->AdvancedSearch->SearchCondition = @$filter["v_CI_DNI"];
		$this->CI_DNI->AdvancedSearch->SearchValue2 = @$filter["y_CI_DNI"];
		$this->CI_DNI->AdvancedSearch->SearchOperator2 = @$filter["w_CI_DNI"];
		$this->CI_DNI->AdvancedSearch->save();
		...
		// Field Tipo_Lector
		$this->Tipo_Lector->AdvancedSearch->SearchValue = @$filter["x_Tipo_Lector"];
		$this->Tipo_Lector->AdvancedSearch->SearchOperator = @$filter["z_Tipo_Lector"];
		$this->Tipo_Lector->AdvancedSearch->SearchCondition = @$filter["v_Tipo_Lector"];
		$this->Tipo_Lector->AdvancedSearch->SearchValue2 = @$filter["y_Tipo_Lector"];
		$this->Tipo_Lector->AdvancedSearch->SearchOperator2 = @$filter["w_Tipo_Lector"];
		$this->Tipo_Lector->AdvancedSearch->save();
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->CI_DNI, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->Tipo_Lector, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Institucion, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->Id_lector); // Id_lector
			$this->updateSort($this->CI_DNI); // CI_DNI
			...
			$this->updateSort($this->Tipo_Lector); // Tipo_Lector
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ew-multi-select\" value=\"" . HtmlEncode($this->Id_lector->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\">";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft_lectorlistsrch\" href=\"#\">" . $Language->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft_lectorlistsrch\" href=\"#\">" . $Language->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft_lectorlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft_lectorlistsrch\">" . $Language->Phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
